defmodule FinincialToolWeb.ClientUserLive.Index do
  ...
  alias FinincialToolWeb.Helps.ErrorHelper
  ...
  defp apply_action(socket, :new, _params) do
    socket
    |> assign(:page_title, "Add Client User")
    |> assign(:user, %User{})
  end
  ...
  defp handle_info_switch(socket, data) do
    case data do
      ...
      {SuccessModalLive, :button_clicked, _} ->
        {:noreply, push_redirect(socket, to: ~p"/Admin/Client/users/management")}
  ...
  defp list_users(%{assigns: _assigns} = socket, params) do
    data = Accounts.list_client_users(Control.create_table_params(socket, params))
