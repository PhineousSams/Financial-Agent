defmodule FinancialAgentWeb.Admin.UserLive.UserLiveFilterComponent do
  ...
  def render(assigns) do
    ...
    <div class="modal-body">
      <.modal
        ...
        show
        on_cancel={JS.patch(~p"/Admin/admin/users/management")}
      >
        <form class="space-y-4 p-4" phx-submit="filter">
          ...
          <div class="modal-footer flex justify-start p-4 border-t border-gray-200">
            <button
              type="submit"
