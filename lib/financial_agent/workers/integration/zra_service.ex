defmodule FinancialAgent.Workers.Integration.ZraService do
  @moduledoc """
  ...
  alias FinancialAgent.Workers.Helpers.ZraEncoder
  ...
  ## Returns
    ...
    * `{:error, reason}` on failure
  """
  # FinancialAgent.Integration.ZraService.get_prn_details("212410230720")
  ...
  """
  # FinancialAgent.Integration.ZraService.phin()
  def phin do
    params = %{
      "currencyCode" => "ZMW",
      "endDate" => "2025-04-29",
